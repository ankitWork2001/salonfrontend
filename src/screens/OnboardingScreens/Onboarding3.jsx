...
import image from '../../assets/Onboarding/onboarding3.png';

// A new placeholder image for the third screen.
const backgroundImage = image;

export default function Onboarding3({ navigation }) {
  // On the last onboarding screen, you'll typically navigate to the main app
  // or the authentication flow (Login/Register).
  const handleGetStarted = () => {
    navigation.navigate('Onboarding4'); // Or replace with your main app screen, e.g., 'Home'
  };
    ...
    <View style={styles.container}>
      ...
      <ImageBackground
        ...
        <View style={styles.contentContainer}>
          <Text style={styles.title}>Find The Best Service</Text>
          <Text style={styles.subtitle}>
            There are various services from the best salons that have become our partners
          </Text>

          {/* Pagination Dots */}
          <View style={styles.paginationContainer}>
            <TouchableOpacity onPress={() => navigation.navigate('Onboarding1')} style={styles.dot} />
